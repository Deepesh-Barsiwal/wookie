...
import Womens from '../src/images/women.jpg'
...
<h3>BEST FOR WOMEN CATEGORIES</h3>
<h6>TOP PRODUCTS OF THIS WEEK</h6>
           </div>
           </div>
           <h1 className="text-primary d-none d-md-block">Women({Count})</h1>
           {/*card*/}
           <div className="row">
           <div className="col col-12 col-sm-6 col-md-6 col-xl-3 ">
           <Card img = {Sale} cardTitle="Torsten Derlaff" cardText="$20.00" cardBtn="ADD TO CART"/>
           </div>
            <div className="col col-12 col-sm-6 col-md-6 col-xl-3">
           <Card img = {img1} cardTitle="Morta Derlaff" cardText="$300.00" cardBtn="ADD TO CART"/>
           </div>
            <div className="col col-12 col-sm-6 col-md-6 col-xl-3">
           <Card img = {Womens} cardTitle="Justin go" cardText="$200.00" cardBtn="ADD TO CART"/>
           </div>
            <div className="col col-12 col-sm-6 col-md-6 col-xl-3">
           <Card img = {Shoes} cardTitle="Elite centa" cardText="$300.00" cardBtn="ADD TO CART"/>
           </div>
             <div className="col col-12 col-sm-6 col-md-6 col-xl-3">
           <Card img = {Womens} cardTitle="Tohito nama" cardText="$600.00" cardBtn="ADD TO CART"/>
           </div>
             <div className="col col-12 col-sm-6 col-md-6 col-xl-3">
